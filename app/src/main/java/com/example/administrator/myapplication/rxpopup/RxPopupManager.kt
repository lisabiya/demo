...
fun showSimplePop(fragmentManager: FragmentManager?) {
    val rxPopup = object : RxPopup() {
        override fun onViewCreated(view: View) {
            setCancelable(true)
            val message = view.findViewById<TextView>(com.example.administrator.myapplication.R.id.tvMessage)
            setViewOnClick(com.example.administrator.myapplication.R.id.ivClose) {
                dismiss()
            }
            setViewOnClick(com.example.administrator.myapplication.R.id.btSet) {
    ...
    if (fragmentManager != null)
        rxPopup.showFragment(fragmentManager, com.example.administrator.myapplication.R.layout.fragment_dialog)
}
